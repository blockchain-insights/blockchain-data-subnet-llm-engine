...
from protocol import LLM_ERROR_SEARCH_TARGET_NOT_SUPPORTED, LLM_ERROR_SEARCH_LIMIT_NOT_SPECIFIED, \
    LLM_ERROR_SEARCH_LIMIT_EXCEEDED, Query, LLM_ERROR_TYPE_NOT_SUPPORTED, QUERY_TYPE_SEARCH
